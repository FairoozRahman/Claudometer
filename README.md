...
## Installation (beta / unpacked)

Claudometer isn't on the Chrome Web Store yet — install it as an unpacked extension from a release archive:

1. Go to the [Releases](../../releases) page and download **`Claudometer-v1.0.0.zip`**
2. Unzip it — you should get a folder containing `manifest.json`, `background.js`, `content.js`, etc.
3. Open `chrome://extensions` in Chrome
4. Toggle **Developer mode** on (top right)
5. Click **Load unpacked** and select the unzipped folder
6. Open or reload a claude.ai tab — the HUD appears in the bottom-right corner
...
| `alarms` | Schedule the 2-minute polling cycle |
